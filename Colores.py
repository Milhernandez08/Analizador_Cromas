...
def Encontrar_Caracteristicas(imagen):
    ...
    Blanco          = cv2.findContours(maskBlanco, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)[0]   
    # Blanco          = cv2.findContours(Zona_Central, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)[0]   
    Amarillo        = cv2.findContours(maskAmarillo, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)[0]       
    Cafe            = cv2.findContours(maskCafe, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)[0]       
    Rojo            = cv2.findContours(maskRojo, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)[0]       
    Naranja         = cv2.findContours(maskNaranja, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)[0]       
    Gris            = cv2.findContours(maskGris, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)[0]       
    Violeta         = cv2.findContours(maskVioleta, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)[0]       
    Verde           = cv2.findContours(maskVerde, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)[0]       
    Azul            = cv2.findContours(maskAzul, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)[0]       
